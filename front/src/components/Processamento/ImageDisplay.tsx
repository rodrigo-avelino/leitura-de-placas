...
interface ImageDisplayProps {
  ...
  onClear: () => void;
  onProcess: () => void;
  isProcessing: boolean; // Corresponde ao prop corrigido em Processar.tsx
  status: "idle" | "running" | "success" | "failed"; // Corresponde ao mapeamento corrigido em Processar.tsx
}
