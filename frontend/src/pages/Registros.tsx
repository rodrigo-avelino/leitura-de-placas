...
import TabelaRegistros, { Registro } from "@/components/Registros/TabelaRegistros";
...
const mockRegistros: Registro[] = [
  {
    ...
    imagemUrl: "https://images.unsplash.com/photo-1485463611174-f302f6a5c1c9?w=800",
  },
  {
    id: 2,
    placa: "XYZ-5678",
    dataHora: "2025-01-15T15:45:00",
    imagemUrl: "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=800",
  },
  {
    id: 3,
    placa: "DEF-9012",
    dataHora: "2025-01-15T16:20:00",
    imagemUrl: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800",
  },
  {
    id: 4,
    placa: "GHI-3456",
    dataHora: "2025-01-16T09:15:00",
    imagemUrl: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=800",
  },
  {
    id: 5,
    placa: "JKL-7890",
    dataHora: "2025-01-16T11:30:00",
    imagemUrl: "https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=800",
  },
];

const Registros = () => {
  const [registros, setRegistros] = useState<Registro[]>(mockRegistros);
  const [filteredRegistros, setFilteredRegistros] = useState<Registro[]>(mockRegistros);



  const handleFilter = (filters: { placa: string; dataInicio: string; dataFim: string }) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        {/* Grid de Registros */}
        <TabelaRegistros registros={filteredRegistros} onDelete={handleDelete} />
      </main>
    </div>
  );
};
